    ...
    hooks: {
      "page:before": function(page) {
        ...
        if (!page.noinsert && page.status) {
          insert += "![" + page.status + "](https://rfc.unprotocols.org/spec:2/COSS/" + page.status + ".svg)\n"
        }

        if (!page.noinsert && page.domain) {
          insert += "* Name: [" + page.domain + "/spec:" + page.shortname + "](https://" + page.domain + "/spec:" + page.shortname + ")\n";
